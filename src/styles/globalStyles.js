export const CSS = `
@import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@300;400;500;600;700&family=Space+Grotesk:wght@400;500;600;700&family=Anton&display=swap');
...
body{background:var(--bg);color:var(--ink);font-family:'DM Sans',sans-serif;margin:0}
...
.btn-royal{display:inline-flex;align-items:center;gap:8px;background:var(--royal);color:#fff;font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:14px;padding:14px 28px;border-radius:14px;border:none;cursor:pointer;transition:all .3s;text-decoration:none}
.btn-royal:hover{background:var(--royal-dark);transform:translateY(-2px);box-shadow:0 8px 24px rgba(26,58,122,0.3)}
.btn-outline{display:inline-flex;align-items:center;gap:8px;border:2px solid var(--ink);color:var(--ink);font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:14px;padding:12px 26px;border-radius:14px;background:transparent;cursor:pointer;transition:all .3s;text-decoration:none}
